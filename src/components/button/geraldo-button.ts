...
export class GeraldoButton extends LitElement {
  @property({ type: String }) variant: GeraldoButtonVariant = 'filled';
  @property({ type: String }) color: GeraldoButtonColor = 'primary';
  @property({ type: String }) size: GeraldoButtonSize = 'md';
